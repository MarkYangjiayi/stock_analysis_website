    ...
    return (
        <aside className="flex h-full w-64 shrink-0 flex-col border-r bg-white dark:bg-[#10171d]" aria-label="Watchlist">
            <div className="border-b p-4">
                ...
                {readOnly ? <button type="button" className="secondary-button mt-4 w-full min-h-9 px-3 text-xs" onClick={onUnlock}><LockKeyhole size={14} /> Unlock to edit</button> : <form onSubmit={handleAdd} className="mt-4 flex gap-2">
